...
Java_com_videoedit_audio_SimpleLame_stringFromJNI(JNIEnv *env, jclass type) {
...
Java_com_videoedit_audio_SimpleLame_convert(JNIEnv *env, jclass type, jobject encoder,
                                             jstring jwav_, jstring jmp3_, jint inSampleRate,
